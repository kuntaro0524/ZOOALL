...
if __name__ == "__main__":
    gonio_xyz = [-1.6577, -0.3455, -1.2477]
    omega = 340.0
    ...
    # step inclined [mm]
    dx = v_step * np.sin(np.radians(omega)) / 1000.0
    dz = v_step * np.cos(np.radians(omega)) / 1000.0
...
Data Directory: /user/target/Data/BL32XU_241008_Kobayashi/{dire}/data/
Sample Name: {prefix}
Serial Offset:     0
...
Scan Condition:   324.00   404.00     1.00  # from to step [deg]
...
Attenuator transmission: 0.0126775
