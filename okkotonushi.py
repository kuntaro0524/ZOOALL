	...
	print time_sec
        ...
        def collectMulti(self,trayid,pinid,prefix,cond,sphi):
                ...
                raster_schedule,raster_path=self.lm.prepRaster(dist=cond.distance,
                        att_idx=self.att_idx,exptime=cond.raster_exp,crystal_id=cond.sample_name)
                ...
                try:
                        ...
                        glist=self.lm.shikaSumSkipStrongMulti(cxyz,sphi,raster_path,
                                scan_id,thresh_nspots=cond.shika_minscore,crysize=crysize,max_ncry=cond.shika_maxhits,
                                mode="peak")
                ...
                multi_sch=self.lm.genMultiSchedule(sphi,glist,cond.osc_width,cond.total_osc,
                        cond.exp_henderson,cond.exp_time,cond.distance,cond.sample_name,prefix=data_prefix)
