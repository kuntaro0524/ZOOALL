...
class MyFrame2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Parameters
        self.confdir = "/isilon/blconfig/bl45xu/"
        ...
        # LOG FILE
        logname = "/isilon/BL32XU/BLsoft/RRRR/03.GUI/98.Factory/Honki/Log/kuma_%s.log" % \
    ...
    def checkAdvanced(self):
        ...
        cond = dict(dose_ds=aimed_dose, wavelength=wavelength, exp_ds=exptime, total_osc=phi_total, osc_width=osc_step,
                    ds_vbeam=beamv_um, reduced_fact=1.0, ntimes=1)
        """
    ...
    def readMultiCondition(self):
        ...
        print "Beam size index on KUMA=", bs_index
        print "Beam size index for BSS=", bs_index + 1
        bs_index_for_bss = bs_index + 1
        flux = self.getFlux(wl)
        beamh_um, beamv_um = self.bsconf.getBeamsizeAtIndex(bs_index_for_bss)
