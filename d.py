...
class ZooNavigator():
    def __init__(self, zoo, ms, esa_csv, is_renew_db=False):
        ...
        self.limit_of_vert_velocity = 480.0  # [um/sec]
    ...
    def goAround(self, zoodb="none"):
        ...
        while(1):
            ...
            try:
                ...
                if self.num_pins == 0:
                    message = "Please check CSV file or ZOODB file."
                else:
        ...
        if checkEnergyFlag == True:
            ...
            if energy_change_flag == True:
                if beamline.upper() == "BL45XU":
                    self.logger.info("Wavelength was changed. You should wait for 20 minutes")
                    #time.sleep(20 * 60)
