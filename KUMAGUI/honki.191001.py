...
if beamline.upper() == "BL45XU":
    host = '172.24.242.59'
    detectordim = 422.0  # [mm in shorter dimension]
...
class MyFrame2(wx.Frame):
    ...
    # This function is called from 2 tabs (helical and multi)
    # self.beamsizePullDown2.GetCurrentSelection -> Multi tab
    ...
    def commonSimulation(self):
        ...
        # Get beamsize and set flux value to GUI box
        ...
        # Calculate rotation speed and set it on GUI box
        ...
        # Number of frames -> total exposure time Box
    ...
    # This is 'generate' schedule button on a Helical setting tab
    def pushOutput(self, event):  # wxGlade: MyFrame2.<event_handler>
        try:
            # Firstly, checking Helical / Single data collection
            state = self.checkbox_1.GetValue()

            # ToDo
            if state == "False":
                print "Single irradiation point data collection"
                singleDataCollection()
            else:
                helicalDataCollection()

            # Function
            def singleDataCollection():
                # Constructor
                bsssch = ScheduleBSS()
    ...
    def checkSingle(self):
        ...
        beamh_um, beamv_um = self.bsconf.getBeamsizeAtIndex(bs_index_for_bss)
        print "BEAMSIZE=",beamh_um, beamv_um
        tmp_exp_time = 1.0
        ...
        # Trans speed is none in single data collection
        ...
        # Dose-limited exposure condition
