...
class IboINOCC:
    def __init__(self,device):
        ...
        self.template_path="/isilon/BL32XU/BLsoft/PPPP/10.Zoo/Images/"
    ...
    def makeBackcamTemplate(self,picture_path="/isilon/BL32XU/BLsoft/PPPP/10.Zoo/Images/"):
        view="back"
        for phi in range(0,360,10):
            phis="%03d"%phi
    ...
    def captureMatchBackcam(self,picpath="/isilon/BL32XU/BLsoft/PPPP/10.Zoo/Images/"):
        template_path="%s/Templates/BackCamera/"%picpath
        template_prefix="bc_"
