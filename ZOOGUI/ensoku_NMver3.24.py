...
class Repository(wx.Frame):
    ...
    def __init__(self, parent, id, title):
        ...
        self.log_window = wx.TextCtrl(rightPanel, -1, '-------', size = (1000,-1), style=wx.TE_MULTILINE)
...
#        for ix in range(num):
#            if self.list.IsChecked(ix):
#                oix = int(self.list.GetItemText(line_index, 1))
