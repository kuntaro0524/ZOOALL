...
.dataset_table tr.alt td {
    ...
    for p in conds:
        ...
        if good_flag == True:
            ...
            t_start_to_mountend = (dbinfo.meas_start_time - dbinfo.mount_start_time).seconds
            t_mountend_to_censtart = (dbinfo.center_start_time - dbinfo.mount_end_time).seconds
            t_censtart_to_cenend = (dbinfo.center_end_time - dbinfo.center_start_time).seconds
            t_cenend_to_rasstart = (dbinfo.raster_start_time - dbinfo.center_end_time).seconds
            t_rasstart_to_rasend = (dbinfo.raster_end_time - dbinfo.raster_start_time).seconds
            t_rasend_to_dsstart = (dbinfo.ds_start_time - dbinfo.raster_end_time).seconds
            t_dsstart_to_dsend = (dbinfo.ds_end_time - dbinfo.ds_start_time).seconds

            print(t_start_to_mountend,t_mountend_to_censtart,t_censtart_to_cenend,t_cenend_to_rasstart,t_rasstart_to_rasend,t_rasend_to_dsstart,t_dsstart_to_dsend)
