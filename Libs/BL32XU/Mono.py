...
class Mono:
    ...
    def __init__(self,srv):
        self.m_dtheta1=Motor(srv,"bl_45in_tc1_stmono_1_dtheta1","pulse")
        self.m_theta=Motor(srv,"bl_45in_tc1_stmono_1","pulse")
        #self.m_thetay1=Motor(srv,"bl_45in_tc1_stmono_1_thetay1","pulse")
        #self.m_zt=Motor(srv,"bl_45in_tc1_stmono_1_zt","pulse")
        #self.m_z2=Motor(srv,"bl_45in_tc1_stmono_1_z2","pulse")

        self.m_energy=Motor(srv,"bl_45in_tc1_stmono_1","kev")
        self.m_wave=Motor(srv,"bl_45in_tc1_stmono_1","angstrom")
        self.s=srv
