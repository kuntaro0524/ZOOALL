...
def test_setdefaults_treats_mode_case_insensitively_for_normal():
    u = make_useresa_for_setdefaults()

    u.df = pd.DataFrame([
        {"desired_exp": "normal", "mode": "Helical", "score_max": 321, "max_crystal_size": 20.0},
        {"desired_exp": "normal", "mode": "MIXED",   "score_max": 654, "max_crystal_size": 20.0},
